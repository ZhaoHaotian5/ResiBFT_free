...
{
	if (phase == PHASE_NEWVIEW_COMMON)
	{
		return "PHASE_NEWVIEW_COMMON";
	}
	else if (phase == PHASE_PREPARE_COMMON)
	{
		return "PHASE_PREPARE_COMMON";
	}
	else if (phase == PHASE_PRECOMMIT_COMMON)
	{
		return "PHASE_PRECOMMIT_COMMON";
	}
	else if (phase == PHASE_COMMIT_COMMON)
	{
		return "PHASE_COMMIT_COMMON";
	}
	else if (phase == PHASE_NEWVIEW_FAST)
	{
		return "PHASE_NEWVIEW_FAST";
	}
	else if (phase == PHASE_PREPARE_FAST)
	{
		return "PHASE_PREPARE_FAST";
	}
	else if (phase == PHASE_PRECOMMIT_FAST)
	{
		return "PHASE_PRECOMMIT_FAST";
	}
	else
	{
		return "";
