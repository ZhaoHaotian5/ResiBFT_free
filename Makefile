...
ResiBFT_App_Cpp_Files := $(filter-out App/Client.cpp App/Keys.cpp App/Server.cpp, $(ResiBFT_App_Cpp_Files))
...
Enclave_Cpp_Files := Enclave/EnclaveBasic.cpp Enclave/TrustedRep.cpp
...
clean:
	@rm -f ResiBFTServer ResiBFTClient ResiBFTKeys $(Enclave_Unsigned_Name) $(Enclave_Signed_Name) $(ResiBFT_App_Cpp_Objects) App/Keys.o App/Client.o App/Server.o App/Enclave_u.* App/sgx_utils/sgx_utils.o $(Enclave_Cpp_Objects) Enclave/Enclave_t.*
